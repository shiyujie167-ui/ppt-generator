...
The sibling preset files remain archived in place for diagnosing historical locks. The legacy palette comparison gallery is intentionally not bundled in this trimmed engine; these files are not a runtime catalog.
